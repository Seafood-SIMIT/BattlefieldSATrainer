...
class WYBaichuanDataModule(pl.LightningDataModule):
    def __init__(self, tokenizer, args_data):
        ...
        self.train_dataset = BaichuanDataset(args_data,tokenizer,self.datasets['train'])
        self.valid_dataset = BaichuanDataset(args_data,tokenizer,self.datasets['validation'])
